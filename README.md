...
OrangeData - это data platform для розничной торговли, собранная как Lakehouse на открытых технологиях. Она обрабатывает данные о клиентах, товарах и продажах через Kafka, MinIO и Iceberg, а на выходе отдаёт готовые витрины и дашборд в Superset.
...
После прогона DAG в Superset сам появляется дашборд с выручкой, числом транзакций, средним чеком, динамикой продаж и топ-10 товаров. Настраивать ничего не нужно.
