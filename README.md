...
OrangeData - учебный lakehouse-проект для обработки данных ритейла. Реализован пайплайн Kafka → Airflow →
MinIO/Iceberg с разделением данных на слои Raw, Silver и Gold, аналитикой через Trino и визуализацией
результатов в Superset (в т.ч. ML модели).
